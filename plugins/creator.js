...
seconds: 22,
fileLength: 22,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴍʏ ᴄʀᴇᴀᴛᴏʀ ᴇʟᴀɪɴᴀ-ᴀɪ', body: wm, sourceUrl: 'https://wa.me/6285786539008?text=hai+bang', thumbnail: await (await fetch(bjir)).buffer(),}} 
 })
